# If the names of 2 friends are the same; what will happen to the program in problem 6.
...
# The key(name) will be updated and will print the last element(value) that was entered.